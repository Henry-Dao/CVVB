function p = wfpt_scalar(t,v,a,z,err)
%% DESCRIPTION:
% This function is copied from Navarro and Fuss (2009)
% NOTE: observed RT: rt = t + t0
% lower boundary: wfpt(t,v,a,z,err)
% upper boundary: wfpt(t,-v,a,a - z,err)
