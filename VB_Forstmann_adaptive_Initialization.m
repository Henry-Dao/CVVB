function [output, initial] = VB_Forstmann_adaptive_Initialization(model,data,initial_MCMC,N_iter,R,epsilon)
...
% ----------------- Sample alpha_j|rest in Gibbs step ---------------------- 
 ...
 % conditional Monte Carlo algorithm to update the random effects   
   ...
   [alpha] = LBA_CMC_Forstmann(model,data,theta_G,alpha,J,D_alpha,R,mean_prop,cov_prop,better_proposal,epsilon);
%     sig2 = theta_G.sig2;
%     mu = theta_G.mu;
%     parfor j=1:J
%         
